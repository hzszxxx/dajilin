...
const headerTextMap: Record<Locale, { subtitle: string; badge: string }> = {
  zh: {
    subtitle: '吉林研学与工业特色旅游平台',
    badge: 'GEO 优先 · AI 导览 · 内容引流',
  },
  en: {
    subtitle: 'Jilin Study Tours & Industrial Tourism Platform',
    badge: 'GEO-first · AI Guide · Content Growth',
  },
  ja: {
    subtitle: '吉林産業研修・工業観光プラットフォーム',
    badge: 'GEO優先 · AIガイド · コンテンツ導線',
  },
  ko: {
    subtitle: '지린 산업 연수 및 공업 관광 플랫폼',
...
> = {
  zh: {
    brandSubtitle: '吉林研学与工业特色旅游平台',
    tagline: '吉林研学与工业特色旅游平台，提供工业研学、自驾定制、行程咨询与合作资源服务。',
    ...
    copyright: '© {year} 大吉林. All rights reserved.',
    privacy: '隐私政策',
    terms: '使用条款',
  ...
  en: {
    brandSubtitle: 'Jilin Study Tours & Industrial Tourism Platform',
    tagline: 'Your gateway to Jilin study tours and industrial tourism: destinations, study tours, Route 331, and official services.',
  ...
  ja: {
    brandSubtitle: '吉林産業研修・工業観光プラットフォーム',
    tagline: '吉林の産業研修・工業観光プラットフォームです。産業研修、旅程定制、協力リソースを提供します。',
    destinationsTitle: '目的地',
  ...
  ko: {
    brandSubtitle: '지린 산업 연수 및 공업 관광 플랫폼',
    tagline: '지린 산업 연수 및 공업 관광 플랫폼입니다. 산업 연수, 自驾定制, 협력 리소스를 제공합니다.',
